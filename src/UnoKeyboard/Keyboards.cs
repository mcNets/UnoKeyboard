    ...
    {
        {
            ...
            new KeyboardModel(
                ...
                [
                    ...
                    new KeyModel(1, 1, 3, 1, VirtualKeys.Get("Underscore")),
                    new KeyModel(1, 1, 4, 1, VirtualKeys.Get("Ampersand")),
                    new KeyModel(1, 1, 5, 1, VirtualKeys.Get("Plus")),
                    new KeyModel(1, 1, 6, 1, VirtualKeys.Get("LParenthesis")),
                    new KeyModel(1, 1, 7, 1, VirtualKeys.Get("RParenthesis")),

                    new KeyModel(1, 2, 0, 1, VirtualKeys.Get("Plus")),
                    new KeyModel(1, 2, 1, 1, VirtualKeys.Get("Backslash")),
                    new KeyModel(1, 2, 2, 1, VirtualKeys.Get("Euro")),
                    new KeyModel(1, 2, 3, 1, VirtualKeys.Get("SingleQuote")),
                    new KeyModel(1, 2, 4, 1, VirtualKeys.Get("Colon")),
                    ...
                    new KeyModel(1, 3, 6, 1, VirtualKeys.Get("Slash")),
